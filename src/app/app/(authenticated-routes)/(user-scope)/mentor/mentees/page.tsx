import MenteeContent from './MenteeContent';

export default function MenteesPage() {
  return (
    <div className="p-8">
      <MentorShipMenteesHeader />
      <MenteeContent />
    </div>
  );
}

function MentorShipMenteesHeader() {
  return (
    <div
    ...
    >
      ...
      >
        <h1 className="font-bold text-3xl text-gray-900">My Mentees</h1>
        <p className="text-gray-900 text-lg">
          Lorem ipsum dolor sit amet consectetur. Ultrices venenatis sit mi
          netus consectetur bibendum lacus eu parturient.
        </p>
      </div>
