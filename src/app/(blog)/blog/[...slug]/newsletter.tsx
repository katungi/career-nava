    ...
    <section className=" rounded-xl bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div className="mx-auto max-w-screen-md sm:text-center">
          <h2 className="mb-4 font-extrabold text-3xl text-white tracking-tight sm:text-4xl">
          ...
          <div className=" mx-auto mb-3 max-w-screen-sm items-center space-y-4 sm:flex sm:space-y-0">
            <div className="relative w-full">
              <label className="mb-2 hidden font-medium text-gray-300 text-sm">
                Email address
              </label>
              ...
              <input
                className=" block h-10 w-full rounded-lg border border-gray-300 border-gray-600 bg-gray-50 bg-gray-700 p-3 pl-10 text-primary text-sm text-white placeholder-gray-400 focus:border-primary-500 focus:ring-primary-500 sm:rounded-none sm:rounded-l-lg"
            ...
            <Button
              ...
              className="rounded-md sm:rounded-tl-none sm:rounded-bl-none "
              variant="secondary"
              onClick={() => {
